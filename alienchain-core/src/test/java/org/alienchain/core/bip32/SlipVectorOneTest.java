...
public class SlipVectorOneTest {
  ...
  @Test
    public void testVectorOneMaster() throws UnsupportedEncodingException {
        ...
        HdAddress address = hdKeyGenerator.getAddressFromSeed(SEED, Network.mainnet, CoinType.alienchain);
  ...
  @Test
    public void testVector0H() throws UnsupportedEncodingException {
        ...
        HdAddress master = hdKeyGenerator.getAddressFromSeed(SEED, Network.mainnet, CoinType.alienchain);
