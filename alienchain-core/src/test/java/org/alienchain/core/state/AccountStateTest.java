...
public class AccountStateTest {
  ...
  @Test
    public void testAccount() {
        ...
        acc.setAvailable(NANO_ALX.of(1));
        acc.setLocked(NANO_ALX.of(2));
        acc.setNonce(3);

        Account acc2 = Account.fromBytes(address, acc.toBytes());
        assertEquals(NANO_ALX.of(1), acc2.getAvailable());
        assertEquals(NANO_ALX.of(2), acc2.getLocked());
  ...
  @Test
    public void testAvailable() {
        ...
        state.adjustAvailable(address, NANO_ALX.of(20));
        assertEquals(NANO_ALX.of(20), state.getAccount(address).getAvailable());

        AccountState state2 = state.track();
        assertEquals(NANO_ALX.of(20), state2.getAccount(address).getAvailable());
  ...
  @Test
    public void testLocked() {
        ...
        state.adjustLocked(address, NANO_ALX.of(20));
        assertEquals(NANO_ALX.of(20), state.getAccount(address).getLocked());

        AccountState state2 = state.track();
        assertEquals(NANO_ALX.of(20), state2.getAccount(address).getLocked());
