#include "org_alienchain_crypto_Native.h"
#include "ripemd160.h"
#include <sodium.h>

JNIEXPORT jbyteArray JNICALL Java_org_alienchain_crypto_Native_h256
(JNIEnv *env, jclass cls, jbyteArray msg)
{
    // check inputs
    if (msg == NULL) {
        env->ThrowNew(env->FindClass("org/alienchain/crypto/CryptoException"), "Input can't be null");
        return NULL;
    }
...
JNIEXPORT jbyteArray JNICALL Java_org_alienchain_crypto_Native_h160
(JNIEnv *env, jclass cls, jbyteArray msg)
{
    // check inputs
    if (msg == NULL) {
...
JNIEXPORT jbyteArray JNICALL Java_org_alienchain_crypto_Native_sign
...
JNIEXPORT jboolean JNICALL Java_org_alienchain_crypto_Native_verify
