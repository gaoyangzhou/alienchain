...
public class AlienchainFrameHandler extends ByteToMessageCodec<Frame> {

    private static final Logger logger = LoggerFactory.getLogger(AlienchainFrameHandler.class);

    private final Config config;

    public AlienchainFrameHandler(Config config) {
        this.config = config;
    }
