...
public class Channel {
    ...
    public void init(ChannelPipeline pipe, boolean isInbound, InetSocketAddress remoteAddress, Kernel kernel) {
        ...
        pipe.addLast("frameHandler", new AlienchainFrameHandler(kernel.getConfig()));
        pipe.addLast("messageHandler", new AlienchainMessageHandler(kernel.getConfig()));
        pipe.addLast("p2pHandler", new AlienchainP2pHandler(this, kernel));
    }
