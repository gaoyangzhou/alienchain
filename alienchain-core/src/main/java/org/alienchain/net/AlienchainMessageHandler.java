...
import org.alienchain.net.msg.MessageException;
import org.alienchain.net.msg.MessageFactory;
...
public class AlienchainMessageHandler extends MessageToMessageCodec<Frame, Message> {

    private static final Logger logger = LoggerFactory.getLogger(AlienchainMessageHandler.class);
    ...
    public AlienchainMessageHandler(Config config) {
        this.config = config;
