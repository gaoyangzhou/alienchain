...
public class AlienchainChannelInitializer extends ChannelInitializer<NioSocketChannel> {

    private static final Logger logger = LoggerFactory.getLogger(AlienchainChannelInitializer.class);
    ...
    /**
     * Create an instance of AlienchainChannelInitializer.
     * 
     * @param kernel
     *            the kernel instance
     * @param remoteNode
     ...
     */
    public AlienchainChannelInitializer(Kernel kernel, Node remoteNode, boolean discoveryMode) {
        this.kernel = kernel;
    ...
    public AlienchainChannelInitializer(Kernel kernel, Node remoteNode) {
