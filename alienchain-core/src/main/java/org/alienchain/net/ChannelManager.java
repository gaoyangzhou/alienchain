...
public class ChannelManager {
    ...
    protected final AlienchainIpFilter ipFilter;

    public ChannelManager(Kernel kernel) {
        ipFilter = new AlienchainIpFilter.Loader()
                .load(new File(kernel.getConfig().configDir(), AlienchainIpFilter.CONFIG_FILE).toPath());
    }
     ...
     * @return
     */
    public AlienchainIpFilter getIpFilter() {
        return ipFilter;
    }
