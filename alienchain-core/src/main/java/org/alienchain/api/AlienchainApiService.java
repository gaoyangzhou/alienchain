...
import org.alienchain.api.http.HttpChannelInitializer;
...
/**
 * Alienchain API launcher
 */
public class AlienchainApiService {

    private static final Logger logger = LoggerFactory.getLogger(AlienchainApiService.class);
    ...
    public AlienchainApiService(Kernel kernel) {
        this.kernel = kernel;
