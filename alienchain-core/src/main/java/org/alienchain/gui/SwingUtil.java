...
import static org.alienchain.gui.TextContextMenuItem.COPY;
import static org.alienchain.gui.TextContextMenuItem.CUT;
import static org.alienchain.gui.TextContextMenuItem.PASTE;
...
public class SwingUtil {
    ...
    /**
     * Formats a Alienchain value without truncation.
     *
     * @param a
     * @return
     */
     ...
     * @return
     */
    public static String getTransactionDescription(AlienchainGui gui, Transaction tx) {
        switch (tx.getType()) {
        case COINBASE:
     ...
     * @return
     */
    public static String describeAddress(AlienchainGui gui, byte[] address) {
     ...
     * @return
     */
    public static Optional<String> getAddressAlias(AlienchainGui gui, byte[] address) {
     ...
     * @return
     */
    public static Optional<String> getAddressDelegateName(AlienchainGui gui, byte[] address) {
