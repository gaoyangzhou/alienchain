...
import org.alienchain.core.event.WalletLoadingEvent;
...
import org.alienchain.gui.dialog.AddressBookDialog;
import org.alienchain.gui.dialog.CreateHdWalletDialog;
import org.alienchain.gui.dialog.InputDialog;
import org.alienchain.gui.dialog.SelectDialog;
import org.alienchain.gui.event.MainFrameStartedEvent;
import org.alienchain.gui.event.WalletSelectionDialogShownEvent;
...
import org.alienchain.gui.model.WalletModel.Status;
 ...
 */
public class AlienchainGui extends Launcher {

    public static final boolean HD_WALLET_ENABLED = false;

    private static final Logger logger = LoggerFactory.getLogger(AlienchainGui.class);
    ...
    public static void main(String[] args) {
        try {
            ...
            // start GUI
            AlienchainGui gui = new AlienchainGui();
    ...
    /**
     * Creates a new Alienchain GUI instance.
     */
    public AlienchainGui() {
     ...
     * @param kernel
     */
    public AlienchainGui(WalletModel model, Kernel kernel) {
        SystemUtil.setLocale(getConfig().locale());
    ...
    protected static void setupLookAndFeel() {
        ...
        System.setProperty("com.apple.mrj.application.apple.menu.about.name", "Alienchain");
    }

    /**
     * Returns the min version of alienchain wallet.
     *
     * @return the min version, or null if failed to retrieve
     */
    protected Version getCurrentVersions() {
        try {
            URL url = new URL("http://api.alienchain.org/version");
