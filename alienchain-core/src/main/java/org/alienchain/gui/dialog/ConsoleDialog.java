 ...
 */
package org.alienchain.gui.dialog;
...
import org.alienchain.util.CircularFixedSizeList;
...
public class ConsoleDialog extends JDialog implements ActionListener {
    ...
    private final transient AlienchainApiImpl api;
    ...
    public ConsoleDialog(AlienchainGui gui, JFrame parent) {
        ...
        this.api = new org.alienchain.api.v2.AlienchainApiImpl(gui.getKernel());
        for (Method m : AlienchainApi.class.getMethods()) {
