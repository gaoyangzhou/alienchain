 ...
 */
package org.alienchain.core.bip32.extern;
...
public class Hex {
    ...
    public static String encode0x(byte[] raw) {
        return org.alienchain.core.bip32.extern.Hex.PREF + encode(raw);
    }
    ...
    public static byte[] decode0x(String hex) throws CryptoException {
        if (hex != null && hex.startsWith(org.alienchain.core.bip32.extern.Hex.PREF)) {
