 ...
 * @see org.alienchain.ui.lnf.beautyeye.BeautyEyeLNFHelper.FrameBorderStyle#translucencyAppleLike
 */
public class BEShadowBorder3 extends NinePatchBorder//AbstractBorder
{
	...
	public BEShadowBorder3()
	{
		...
		, org.alienchain.ui.lnf.beautyeye.widget.__Icon9Factory__.getInstance().getBorderIcon_Shadow3());
	}
