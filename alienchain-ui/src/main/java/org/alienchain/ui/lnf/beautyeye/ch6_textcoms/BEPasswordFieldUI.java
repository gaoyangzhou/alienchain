...
package org.alienchain.ui.lnf.beautyeye.ch6_textcoms;
...
import org.alienchain.ui.lnf.beautyeye.ch6_textcoms.__UI__.BgSwitchable;
import org.alienchain.ui.lnf.beautyeye.widget.FocusListenerImpl;
import org.alienchain.ui.ninepatch4j.NinePatch;
...
public class BEPasswordFieldUI extends BasicPasswordFieldUI implements BgSwitchable
	,org.alienchain.ui.lnf.beautyeye.BeautyEyeLNFHelper.__UseParentPaintSurported//WindowsPasswordFieldUI
{
...
//    	c.addMouseListener(new NLLookAndFeel.EditMenu());
    ...
    /* (non-Javadoc)
     * @see org.alienchain.ui.lnf.beautyeye.ch6_textcoms.__UI__.BgSwitchable#switchBgToNomal()
     */
    ...
    /* (non-Javadoc)
     * @see org.alienchain.ui.lnf.beautyeye.ch6_textcoms.__UI__.BgSwitchable#switchBgToFocused()
     */
