...
public class __UI__
{
	...
	public static void uiImpl()
	{
		...
		//JSplitePane的边框实现
		UIManager.put("SplitPane.border",new BorderUIResource(new org.alienchain.ui.lnf.beautyeye.ch4_scroll.ScrollPaneBorder()));//BorderFactory.createEmptyBorder(0, 0, 0, 0)));
