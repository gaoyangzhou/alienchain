 ...
 */
package org.alienchain.ui.lnf.beautyeye.ch14_combox;
...
public class BEComboBoxUI extends BasicComboBoxUI 
	implements org.alienchain.ui.lnf.beautyeye.BeautyEyeLNFHelper.__UseParentPaintSurported
{
    /**
     * Creates the ui.
     *
    ...
    public void paintCurrentValueBackground(Graphics g,Rectangle bounds,boolean hasFocus) 
    {
    	...
    	if(!isUseParentPaint())
    	{
    		if ( comboBox.isEnabled() )
    			org.alienchain.ui.lnf.beautyeye.ch6_textcoms.__Icon9Factory__.getInstance().getTextFieldBgNormal()
    			.draw((Graphics2D)g, 0,0,comboBox.getWidth(),comboBox.getHeight());
    		else
    			org.alienchain.ui.lnf.beautyeye.ch6_textcoms.__Icon9Factory__.getInstance().getTextFieldBgDisabled()
    			.draw((Graphics2D)g, 0,0,comboBox.getWidth(),comboBox.getHeight());
    	}
    	else
    	{
