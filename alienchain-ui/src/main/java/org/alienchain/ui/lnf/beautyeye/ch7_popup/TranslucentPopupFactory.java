...
import org.alienchain.ui.lnf.beautyeye.utils.WindowTranslucencyHelper;
import org.alienchain.ui.lnf.beautyeye.widget.ImageBgPanel;
				...
				ImageBgPanel imageContentPane = new ImageBgPanel().setN9(
						isTooltip?
								...
								:isComboBoxPopup?//是下拉框列表则使一个跟JScrollPane一样的背景图，好看！
										org.alienchain.ui.lnf.beautyeye.ch4_scroll.__Icon9Factory__.getInstance().getScrollPaneBorderBg()
