...
import org.alienchain.ui.lnf.beautyeye.BeautyEyeLNFHelper.FrameBorderStyle;
import org.alienchain.ui.lnf.beautyeye.winlnfutils.WinUtils;
...
public class BeautyEyeLookAndFeelWin extends WindowsLookAndFeel
{
	...
	public BeautyEyeLookAndFeelWin()
	{
		...
		org.alienchain.ui.lnf.beautyeye.ch20_filechooser.__UI__.uiImpl_win();
...
//			UIManager.put("PopupMenu.border",new BorderUIResource(BorderFactory.createEmptyBorder(20,10,20,10)));//	
			...
			UIManager.put("CheckBoxMenuItem.checkIcon"
					,new org.alienchain.ui.lnf.beautyeye.ch9_menu.BECheckBoxMenuItemUI.CheckBoxMenuItemIcon().setUsedForVista(true));//javax.swing.plaf.basic.BasicIconFactory.CheckBoxMenuItemIcon);
			UIManager.put("RadioButtonMenuItem.checkIcon"
					,new org.alienchain.ui.lnf.beautyeye.ch9_menu.BERadioButtonMenuItemUI.RadioButtonMenuItemIcon().setUsedForVista(true));
		}
	}
    ...
    {
        table.addResourceBundle( "org.alienchain.ui.lnf.beautyeye.resources.beautyeye" );
    }
