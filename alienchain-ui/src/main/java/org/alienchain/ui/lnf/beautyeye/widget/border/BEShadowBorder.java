 ...
 */
package org.alienchain.ui.lnf.beautyeye.widget.border;
 ...
 * @see org.alienchain.ui.lnf.beautyeye.BeautyEyeLNFHelper.FrameBorderStyle#translucencySmallShadow
 */
public class BEShadowBorder extends NinePatchBorder//AbstractBorder
{
	...
	public BEShadowBorder()
	{
		super(new Insets(TOP, LEFT, BOTTOM, RIGHT)
				, org.alienchain.ui.lnf.beautyeye.widget.__Icon9Factory__.getInstance().getBorderIcon_Shadow1());
	}
