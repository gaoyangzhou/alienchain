 ...
 */
package org.alienchain.ui.lnf.beautyeye.ch1_titlepane;
...
import org.alienchain.ui.lnf.beautyeye.BeautyEyeLNFHelper;
import org.alienchain.ui.lnf.beautyeye.utils.BEUtils;
import org.alienchain.ui.lnf.beautyeye.utils.JVM;
import org.alienchain.ui.lnf.beautyeye.utils.LogHelper;
import org.alienchain.ui.lnf.beautyeye.utils.MySwingUtilities2;
import org.alienchain.ui.lnf.beautyeye.utils.ReflectHelper;
	...
	private void createActions()
	{
		...
		if (getWindowDecorationStyle() == JRootPane.FRAME)
		{
					...
					UIManager.getString("BETitlePane.setupButtonText",getLocale()))
			{
				...
				{
					JOptionPane.showMessageDialog(rootPane, "这是一个测试版本！！！" +
							"\n" +
							"币仅限于交易测试，请勿流通！");
				}
			};
